...
$$  
r_{hb} = 0.03 \text{ RPS (эффективный на backend)}  
$$

- **Chat API:**  
  Активность чата в реальных системах ~0.3–0.5 сообщений в минуту среди активных; активных пишущих ~15–20%. 20% участников × 0.4 msg/мин:
