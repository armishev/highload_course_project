...
> **Почему primary в Москве:** это крупнейшая точка обмена интернет-трафиком в РФ (MSK-IX) [[25]](#список-источников), что даёт лучшую связность с провайдерами и минимальную сетевую задержку для слоя управления.
